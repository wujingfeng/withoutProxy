...
def gljs_ry_detail_pipline(data):
    ...
    cursor = conn.cursor()
    # 人员信息
    rysql = "INSERT INTO gljs_person(staff_id,gs_id,gljs_xm,gljs_xb,gljs_birth,idcard,gsmc,gljs_xl,gljs_byyx,gljs_sxzy,gljs_zw,gljs_ksgznf,person_link,created,gljs_type,xxly) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
